...
impl Pay {
    ...
    pub fn wechat(over_config: WechatConfigOverride) -> crate::wechat::client::WechatClient {
        let cfg = Self::cfg();
    ...
    pub fn alipay(over_config: AlipayConfigOverride) -> crate::alipay::client::AlipayClient {
        let cfg = Self::cfg();
